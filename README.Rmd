...
<!-- badges: start -->
  [![Launch Rstudio Binder](http://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/robschick/testbuild/master?urlpath=rstudio)
  <!-- badges: end -->
...
Or you can install this compendium as an R package, testbuild, from GitHub with:
### Licenses
